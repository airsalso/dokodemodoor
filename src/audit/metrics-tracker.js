...
export class MetricsTracker {
   ...
   */
  /**
   * [목적] 단일 에이전트 rolled-back 처리.
   *
   * [호출자]
   * - AuditSession.markMultipleRolledBack()
   */
   ...
   *
   * [호출자]
   * - AuditSession.updateSessionStatus()
   */
   ...
   *
   * [호출자]
   * - endAgent(), markRolledBack(), markMultipleRolledBack()
   */
   ...
   */
  /**
   * [목적] session.json 원자적 저장.
   *
   * [호출자]
   * - initialize(), endAgent(), markRolledBack()
   */
  async save() {
